        ...
        <main className="dashboard-content page-fade" style={{ padding: '2rem 0' }}>
            ...
            <div className="glass-card hero-gradient" style={{ padding: '2.5rem', marginBottom: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ background: 'var(--glass-overlay)', padding: '1.5rem 2.5rem', borderRadius: '16px', border: '1px solid var(--glass-overlay-border)', textAlign: 'center' }}>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.25rem' }}>Available Balance</p>
                    <h2 style={{ fontSize: '2.5rem', fontWeight: '800', color: 'var(--text-primary)', margin: 0 }}>₱{balance.toFixed(2)}</h2>
                </div>
            </div>
                ...
                {userRole !== 'creator' && (
                    <div className="glass-card" style={{ padding: '2rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.25rem', color: 'var(--text-primary)', margin: 0 }}>Deposit Funds</h3>
                        </div>
                        <form onSubmit={handleDeposit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            ...
                            <button type="submit" style={{ background: 'var(--glass-overlay)', color: 'var(--text-primary)', border: '1px solid var(--glass-overlay-border)', padding: '0.85rem', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', marginTop: '0.5rem' }}>
                                Fund Wallet
                            </button>
                        </form>
                    </div>
